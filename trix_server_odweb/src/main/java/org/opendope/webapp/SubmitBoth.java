/*
 * Modified file. Not the original one.
 * https://github.com/plutext/OpenDoPE-WAR
...
//				"text/html"})
	public /*Response*/ static void processForm(
			//@Context ServletContext servletContext, 
//			@FormDataParam("xmlfile")
			InputStream xis,
//			@FormDataParam("xmlfile")
//			FormDataContentDisposition xmlFileDetail,
//			@FormDataParam("docx")
			InputStream docxInputStream,
//			@FormDataParam("docx")
//			FormDataContentDisposition docxFileDetail,
//			@QueryParam("format")
			String format,
			OutputStream docxOutputStream
